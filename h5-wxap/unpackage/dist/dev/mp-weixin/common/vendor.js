...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"haowu","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 12:
/*!************************************************************!*\
  !*** D:/myproject/wellgoods/h5-wxap/common/api/request.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _main = __webpack_require__(/*! ../../main.js */ 0);
...
{
  http: http,
  http2: http2 };exports.default = _default;
...
/***/ 13:
/*!*****************************************************!*\
  !*** D:/myproject/wellgoods/h5-wxap/store/index.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    login: function login(state, userData) {//登录存储token
      state.userData = userData || { id: '' };
      state.userToken = userData.token || '';
      uni.setStorageSync('userData', userData);
      uni.setStorageSync('userToken', userData.token);
    },
    SET_BARTITLE: function SET_BARTITLE(state, data) {
      state.navigationBarTitle = data;
    },
    autoLogin: function autoLogin(state, _autoLogin) {
      state.autoLogin = _autoLogin;
    },
    loginH5: function loginH5(state, userBaseinfo) {
      state.userBaseinfo = userBaseinfo;
      uni.setStorageSync('userBaseinfo', userBaseinfo);
    },
    showBindingPhone: function showBindingPhone(state) {//绑定手机弹窗
      state.bindingPhone = true;
    },
    closeBindingPhone: function closeBindingPhone(state) {//关闭绑定手机弹窗
      state.bindingPhone = false;
    },
    choiceFooter: function choiceFooter(state, num) {//切换底部导航
      state.footerClass = num;
    },
    Sensitive: function Sensitive(state, is) {//判断是否显示敏感的字
      state.isSensitive = is;
    },
    invitation: function invitation(state, num) {//邀请码
      state.invitationCode = num;
    },
    // getBottomHeight(state,num){//适配底部
    // 	state.bottomHeight = num
    // },
    addIsOne: function addIsOne(state, num) {//首页跳登录就加载一次
      state.isOne = num;
    } },
...
/***/ 130:
/*!************************************************************************!*\
  !*** D:/myproject/wellgoods/h5-wxap/common/api/user/singleCardFree.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 免单卡
...
{
  queryFreeBillFirstPage: queryFreeBillFirstPage,
  getFirstGetCashFreeBill: getFirstGetCashFreeBill,
  queryShareData: queryShareData,
  queryMyInvite: queryMyInvite,
  receiveFreeCardByInvite: receiveFreeCardByInvite,
  queryFreeBillCardList: queryFreeBillCardList };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 155:
/*!*********************************************************!*\
  !*** D:/myproject/wellgoods/h5-wxap/common/download.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function downloadImg(url) {
  uni.showLoading({
    title: '正在保存',
    mask: true });
...
{
  downloadImg: downloadImg };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 21:
/*!****************************************************************!*\
  !*** D:/myproject/wellgoods/h5-wxap/common/api/index/index.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function search(_this) {
  _this.$reqHttp({
    ...
    success: function success(res) {
      if (res.data.success) {
        _this.productList = [].concat(_toConsumableArray(_this.productList), _toConsumableArray(res.data.result.records));
...

{
  swiper: swiper,
  goodsType: goodsType,
  queryMyIndex: queryMyIndex,
  search: search,
  swiperDetail: swiperDetail,
  addGoodsScanNumber: addGoodsScanNumber,
  addFavorite: addFavorite,
  deleteFavorite: deleteFavorite,
  queryFavorite: queryFavorite,
  queryCustomerQrCode: queryCustomerQrCode,
  shareGoods: shareGoods,
  topThreeGoods: topThreeGoods,
  getZoneAllGoods: getZoneAllGoods,
  checkExchange: checkExchange };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 4:
/*!*************************************************!*\
  !*** D:/myproject/wellgoods/h5-wxap/pages.json ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 68:
/*!*******************************************************************!*\
  !*** D:/myproject/wellgoods/h5-wxap/common/api/index/exchange.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 答题
// 步骤1
...

{
  ...
  manualCancelOrder: manualCancelOrder,
  answerTitle: answerTitle,
  answerTitleResult: answerTitleResult,
  answerShopTitleResult: answerShopTitleResult,
  goCheckOrder: goCheckOrder,
  modifyOrderRebateAmt: modifyOrderRebateAmt,
  checkOrder: checkOrder,
  taobaoCheckGoods: taobaoCheckGoods };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 8:
/*!*******************************************************!*\
  !*** D:/myproject/wellgoods/h5-wxap/common/common.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 提示
...
// H5登录
function author4H5(_this) {var _this2 = this;
  _this.$reqHttp2({
    url: "/auth4H5",
    data: {
    ...
    success: function success(res) {
      ...
      // }
      if (res.data.success) {
        var userData = JSON.parse(res.data.result.userData) || { token: '' };
        console.log(userData);
        _this.$store.commit("autoLogin", res.data.result.autoLogin || false);
        _this.$store.commit("login", userData);
        _this2.queryVersion(_this); //登录完成后在调用一次获取敏感字
      }
...
// 手机号码注册
function phoneRegister(_this, url) {var _this3 = this;
  _this.$reqHttp2({
    ...
    success: function success(res) {
      ...
      if (res.data.code == 200) {
        ...
        _this3.queryVersion(_this); //登录完成后在调用一次获取敏感字
        if (url == 1) {
          uni.reLaunch({
            url: '/pages/index/index',
            success: function success() {
...

{
  ...
  queryInit: queryInit };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 93:
/*!**************************************************************!*\
  !*** D:/myproject/wellgoods/h5-wxap/common/api/user/user.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  receiveRebate: receiveRebate,
  queryOrderDetail: queryOrderDetail,
  manualCancelOrder: manualCancelOrder,
  queryGetCashDetail: queryGetCashDetail,
  cashOut: cashOut,
  shareWxApp: shareWxApp,
  queryEvaOrders: queryEvaOrders,
  queryOrderEvaluate: queryOrderEvaluate,
  getEvaluateForFreeCard: getEvaluateForFreeCard,
  submitEva: submitEva,
  getcapimg: getcapimg,
  cancelEva: cancelEva,
  getfreeCard: getfreeCard };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
