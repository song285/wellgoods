	...
	export default {
		...
		methods: {
			...
			choice(num) {
				this.state = num
				this.list = []
				if (num == 1 && this.myOrder2.ALL != null) {
					this.list = this.myOrder2.ALL
				}
				if (num == 2 && this.myOrder2.UN_FINISH != null) {
					this.list = this.myOrder2.UN_FINISH
				}
				if (num == 3 && this.myOrder2.TO_GET_GOODS != null) {
					this.list = this.myOrder2.TO_GET_GOODS
				}
				if (num == 4 && this.myOrder2.FINISH != null) {
					this.list = this.myOrder2.FINISH
				}
				if (num == 5 && this.myOrder2.REFUND != null) {
					this.list = this.myOrder2.REFUND
				}
			},
			showPopup(orderId) {
